  ...
  return (
    <section id="portfolio" className="py-20 px-6 bg-gray-50">
      <div className="max-w-6xl mx-auto">
        ...
        >
          <h2 className="heading-2 mb-4">Our Work</h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {projects.map((project, index) => (
            ...
            >
              <div className="h-48 bg-gradient-to-br from-navy to-amber-500 flex items-center justify-center">
              ...
              <div className="p-6">
                ...
                <div className="space-y-2 text-sm">
                  <div className="flex justify-between items-center">
                    ...
                    <span className="font-bold text-navy">{project.metrics.lighthouse}</span>
                  </div>
                  <div className="flex justify-between items-center">
                    <span className="text-gray-600">Performance</span>
                    <span className="font-bold text-navy">{project.metrics.performance}</span>
                  </div>
                  <div className="flex justify-between items-center">
                    <span className="text-gray-600">Accessibility</span>
                    <span className="font-bold text-navy">WCAG {project.metrics.accessibility}</span>
                  </div>
                </div>
              </div>
            </motion.div>
